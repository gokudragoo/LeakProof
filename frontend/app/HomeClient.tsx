...
const features = [
  {
    ...
    description: 'CoFHE protects confidential severity and voting values on-chain.',
  },
  {
    icon: (
      <svg className="w-7 h-7" fill="none" viewBox="0 0 24 24" stroke="currentColor">
  ...
  },
  {
    ...
    title: 'IPFS Storage',
    description: 'Encrypted report and evidence blobs stored on IPFS with on-chain references.',
  },
  {
    icon: (
      <svg className="w-7 h-7" fill="none" viewBox="0 0 24 24" stroke="currentColor">
    ...
    description: 'Confidential reviewer votes finalize through admin-published proofs.',
  },
  {
    icon: (
      <svg className="w-7 h-7" fill="none" viewBox="0 0 24 24" stroke="currentColor">
...
const steps = [
  ...
  },
  {
    ...
    description: 'Consensus proofs update case status on-chain.',
    icon: (
      <svg className="w-6 h-6" fill="none" viewBox="0 0 24 24" stroke="currentColor">
...
const faqs = [
  {
    ...
    a: 'Your wallet address is your pseudonymous identifier. Report contents and evidence are encrypted in-browser before IPFS upload.',
  },
  {
    q: 'How does the review process work?',
    a: 'Admins assign reviewers to cases. Reviewers vote confidentially, then an admin publishes CoFHE-backed tally proofs to update status.',
  },
  {
  ...
  },
  {
    ...
    a: 'Evidence files are encrypted before IPFS upload. The public CID points to ciphertext, while the case access key stays off-chain.',
  },
];
...
type HomeClientProps = {
  initialStats: HomeStatsSnapshot;
};

export default function HomeClient({ initialStats }: HomeClientProps) {
  const { isConnected } = useAccount();
  const [statsState, setStatsState] = useState({
    caseCount: initialStats.caseCount,
    verifiedCount: initialStats.verifiedCount,
    activeCount: initialStats.activeCount,
    loading: false,
  });
  ...
  useEffect(() => {
    ...
    fetch('/api/stats', { cache: 'no-store' })
      ...
      .then((stats) => {
        if (!active) return;
        setStatsState({
          caseCount: Number(stats.caseCount ?? 0),
      ...
      <section className="relative pt-32 pb-20 px-6">
        <div className="max-w-6xl mx-auto">
          <div className="text-center max-w-4xl mx-auto">
            ...
            {/* Main Heading */}
            <h1 className="text-4xl sm:text-5xl md:text-6xl lg:text-7xl font-black leading-tight mb-6 slide-up animate-delay-100">
              <span className="gradient-text">Secure</span><span className="block sm:inline"> Whistleblowing</span>
              <br />
            ...
            <p className="text-lg md:text-xl text-gray-400 max-w-2xl mx-auto mb-10 slide-up animate-delay-200">
              Submit encrypted reports with CoFHE-backed severity and voting.
              On-chain verification, multi-role access, and private evidence handling.
            </p>
            ...
            <div className="grid grid-cols-3 gap-4 md:gap-6 max-w-2xl mx-auto slide-up animate-delay-400">
              <div className="glass-card p-5 text-center">
                <div className="text-3xl md:text-4xl font-bold gradient-text mb-1">
                  {statsState.loading ? '...' : <AnimatedCounter end={statsState.caseCount} />}
                </div>
              ...
              <div className="glass-card p-5 text-center">
                <div className="text-3xl md:text-4xl font-bold text-emerald-400 mb-1">
                  <AnimatedCounter end={statsState.verifiedCount} />
                </div>
              ...
              <div className="glass-card p-5 text-center">
                <div className="text-3xl md:text-4xl font-bold text-amber-400 mb-1">
                  <AnimatedCounter end={statsState.activeCount} />
                </div>
          ...
          <div className="grid md:grid-cols-4 gap-12 mb-12">
            ...
            <div className="md:col-span-2">
              ...
              <p className="text-gray-400 text-sm max-w-md mb-6">
                Privacy-first whistleblowing platform built on Ethereum with client-side encryption,
                CoFHE-backed review flows, and decentralized audit trails.
              </p>
